<?php
	...
	$exclude = $posts_num = $title = $pagination = $share = $offset = '';
	...
	?>
		...
		<?php if ( !empty( $pagination ) && empty($offset) &&  $cat_query->max_num_pages > 1){?> <div class="recent-box-pagination"><?php tie_pagenavi($cat_query , $posts_num); ?> </div> <?php } ?>
		<div class="clear"></div>
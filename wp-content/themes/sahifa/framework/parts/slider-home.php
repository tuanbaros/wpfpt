...
if( $get_meta['slider_type'][0] == 'elastic' ):
	...
	$autoplay = $get_meta[ 'elastic_slider_autoplay' ][0];
		...
		<?php $i= 0;
			...
			<?php endif; ?>
				<div class="ei-title">
					...
					<?php if ($get_meta[ 'slider_caption' ][0]) : ?><h3><?php echo tie_content_limit( get_the_excerpt() , $caption_length ) ?></h3><?php endif; ?>
				</div>
			</li>
		<?php endwhile;?>
		</ul>
		...
		<?php while ( $featured_query->have_posts() ) : $featured_query->the_post()?>
			...
			<?php endif; ?>
				<div class="slider-caption">
					<h2><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
					<?php if ($get_meta[ 'slider_caption' ][0]) : ?><p><?php echo tie_content_limit( get_the_excerpt() , $caption_length ) ?></p><?php endif; ?>
				</div>
			</li>
		<?php endwhile;?>
		</ul>

...
$colors_styling = array (
	...
	"footer#theme-footer a"							=> 'footer_links_color',
	"footer#theme-footer a:hover"					=> 'footer_links_color_hover',
);
...
$bg_styling = array (
	...
	"footer#theme-footer"		 => 'footer_background',
...
.tie-cat-<?php echo $category_id ?> a.more-link {background-color:<?php echo $cat_custom_color; ?>;}
.tie-cat-<?php echo $category_id ?> .cat-box-content {border-bottom-color:<?php echo $cat_custom_color;?>; }
		<?php
		}
	}
}
